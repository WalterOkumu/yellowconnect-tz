             ...
             <div className="flex flex-wrap md:flex-nowrap md:flex-row mx-auto justify-center gap-16 md:w-3/4 w-1/2">
                ...
                <div className="md:w-[14rem] w-[12rem] border cursor-pointer hover:shadow-xl duration-500 ease-out px-3 py-4 rounded-md text-center">
                    ...
                    <div className="">
                        ...
                        <button className="bg-[#FBED04] mt-28 px-8 py-1 rounded font-bold text-sm">Know more</button>
                    </div>
                </div>
                <div className="md:w-[14rem] w-[12rem] border cursor-pointer hover:shadow-xl duration-500 ease-out px-3 py-4 rounded-md text-center">
                    ...
                    <button className="bg-[#FBED04] mt-4 px-8 py-1 rounded font-bold text-sm">Know more</button>
                </div>
                <div className="md:w-[14rem] w-[12rem] border cursor-pointer hover:shadow-xl duration-500 ease-out px-3 py-4 rounded-md text-center">
