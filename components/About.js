...
export default function About() {
    return(
        <div className="md:w-1/2 md:mt-16 pb-8 flex flex-col items-center md:text-center justify-center mx-auto mt-16 px-8 text-left">
                    <h1 className="text-5xl font-bold  md:text-center text-[#FBED04] ">Jenga uwepo thabiti wa kidijitali</h1>
                    <h2 className="text-2xl italic font-light pt-2  md:text-left text-left">
                        <span className="font-bold">Tangaza biashara yako kwa uchapishaji na kidijitali! </span>
                            Kwa kifurushi cha Yellow Connect.</h2>
                    <div className="pt-8 ">
                        <p className="leading-relaxed md:text-left text-left">
